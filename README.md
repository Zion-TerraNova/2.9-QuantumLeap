...
|-----------|------|----------|----------|
| **Cosmic Harmony** | Blake3+Keccak+φ | GPU | High |
...
│                    QDL Framework                     │
├─────────────┬─────────────┬─────────────────────────┤
│  Compiler   │  Simulator  │  Distributed Runtime    │
│  QDL→Python │  Quantum    │  Multi-node execution   │
│             │  Circuits   │                         │
├─────────────┴─────────────┴─────────────────────────┤
│              ZQAL (Quantum Algorithm Language)       │
│              Define custom mining algorithms         │
└─────────────────────────────────────────────────────┘
\`\`\`
...
📁 **Explore QDL**: See [qdl/](qdl/) folder for full SDK, examples, and documentation.
...
Mining earns XP that increases your reward multiplier (1× to 15×). Higher levels = bigger rewards.
...
- [Mining Guide](docs/mining-guide.md) — Detailed mining tutorial
- [Economic Model](docs/economic-model.md) — Tokenomics
- [API Reference](docs/api-reference.md) — Pool & Node APIs
- [Whitepaper Lite](docs/whitepaper-lite.md) — Project vision
...
- 🌍 [zionterranova.com](https://zionterranova.com)
