...
- `zqal-sdk/`: ZION Quantum Algorithm Language (DSL for mining algorithms)- `qdl/`: Quantum Data Language — distributed quantum computing framework- `golden-egg/`: Golden Egg treasure hunt game skeleton (1.75B ZION prize pool)
